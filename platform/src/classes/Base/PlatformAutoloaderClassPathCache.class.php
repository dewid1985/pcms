 ...
 *                                                                         *
 ***************************************************************************/
class PlatformAutoloaderClassPathCache implements AutoloaderRecachable, AutoloaderWithNamespace
{
    ...
    public function autoload($className, $recache = false)
    {
        ...
        if ($fileName = $this->getFileName($className)) {
            ...
            return $this->includeFile(PATH_PLATFORM_CLASSES . str_replace("\\", "/", $className) . '.class.php');
        }
    }
